...
# Prueba automática
Write-Host " "
Write-Host "INSTRUCCIONES DE ATAQUE:" -ForegroundColor Yellow
Write-Host "1. Abre otra terminal."
Write-Host "2. Ejecuta: ssh root@$PublicIp -p 22"
Read-Host "Pulsa ENTER cuando hayas hecho el ataque..."
